...
export const Contact = () => {
    ...
    return (
        <section id="contact" className="section-padding bg-muted/50 transition-colors">
                        ...
                        <Card className="p-6 md:p-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm mt-1">123 Tech Street, Karachi, Pakistan</p>
                                </div>
                            </div>
                        </Card>
                        ...
                        <Card className="p-6 md:p-8">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground text-sm mt-1">info@nexora.com</p>
                                    <p className="text-muted-foreground text-sm">support@nexora.com</p>
                                </div>
                            </div>
                        </Card>
